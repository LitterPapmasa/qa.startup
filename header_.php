...
<head>
    ...
    <link href="<?= $path;?>css/fileinput.css?v=1.0" rel="stylesheet" type="text/css">
    ...
    <script type="text/javascript" src="<?= $path;?>js/fileinput.js?v=1.0"></script>
    <script type="text/javascript" src="<?= $path;?>js/redirect.js?v=1.0"></script>
    <!--[if lt IE 9]>
