...
<section id="feedback">
    <div class="container no-flickr">
        ...
        <div class="feedback-form">
			...
			<br><br>
            <form id="feedbackdb-form"  method="post" action="javascript:void(0);" onsubmit="ajaxFeedback('<?php echo $path ?>')" class="animation-fadeIn" role="form" enctype="multipart/form-data">
